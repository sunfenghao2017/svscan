...
struct AlignDescriptor{
    int32_t mCSStart = 0;        ///< number of cns bases consumed before gap aln beg
    int32_t mCSEnd = 0;          ///< number of cns bases consumed after 1base of gap aln end
    int32_t mRefStart = 0;       ///< number of ref bases consumed before gap aln beg
    int32_t mRefEnd = 0;         ///< number of ref bases consumed after 1base of gap aln end
