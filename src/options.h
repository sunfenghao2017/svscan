...
struct SVFilter{
    ...
    int32_t mMaxHomLen = 10;          ///< maximal homologuous length of split reads
    ...
    uint32_t mGraphPruning = 1000;     ///< PE graph pruning cutoff
    int32_t mMaxReadPerSV = 1000;      ///< maximum valid split-reads sampled to analysis one SV event
