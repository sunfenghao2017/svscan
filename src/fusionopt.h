...
struct FusionOptions{
    ...
    FusionOptions(){
        ...
        mIDBDropMask = (FUSION_FBLACKGENE | FUSION_FBLACKPAIR  | FUSION_FFBG | FUSION_FINSAMEGENE |
                        FUSION_FTOOSMALLSIZE | FUSION_FLOWAF | FUSION_FLOWSUPPORT | FUSION_FLOWDEPTH);
        mKeepMasks = {(FUSION_FHOTGENE | FUSION_FREALNPASSED | FUSION_FINREPORTRNG),
                      (FUSION_FHOTGENE | FUSION_FINDB | FUSION_FINREPORTRNG),
                      (FUSION_FHOTGENE | FUSION_FMIRRORINDB |  FUSION_FINREPORTRNG)};
        mPrimaryMask = (FUSION_FNORMALCATDIRECT | FUSION_FCOMMONHOTDIRECT | FUSION_FINDB | FUSION_FALLGENE | FUSION_FREALNPASSED);
